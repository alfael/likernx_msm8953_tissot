...
#define TCP_TIMEWAIT_LEN (40*HZ) /* how long to wait to destroy TIME-WAIT
...
#define TCP_KEEPALIVE_TIME	(100*60*HZ)	/* two hours */
#define TCP_KEEPALIVE_PROBES	4		/* Max of 9 keepalive probes	*/
#define TCP_KEEPALIVE_INTVL	(50*HZ)
